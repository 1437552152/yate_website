...
function showMyAddress(showBg) {
    ...
    jFrm.attr("src", "http://www.badese.com/JS/layer/MyAddress.aspx");
    setCM("divCartMyAddr");
...
//    $j("div_nsw_news_advan_cntr").find("iframe").attr("src", "http://www.badese.com/news/AdvanSearch.aspx");
...
function advanNewsSearch() {
    var url = "http://www.badese.com/search/news.aspx?type=";
